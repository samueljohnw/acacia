...
class UsersController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, Transactional $transaction)
    {
    ...
    public function add_recipient(Recipient $recipient, Request $r, $id)
    {
        ...
        \DB::transaction(function () use ($user, $r, $recipient) {
            ...
            \DB::table('users')->where('id',$user['id'])->update(['recipient_id' => $recipient->id]);
        });
